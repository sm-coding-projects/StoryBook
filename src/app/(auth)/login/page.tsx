    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-neutral-950 items-center justify-center p-12">
        <div className="max-w-md text-center">
          <Camera className="size-16 text-white mx-auto mb-6" strokeWidth={1.5} />
          <h1 className="text-4xl font-light text-white tracking-tight mb-4">
            StoryBook
          </h1>
          <p className="text-neutral-400 text-lg font-light">
            Beautiful client galleries for photographers
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center p-8">
        <div className="w-full max-w-sm space-y-8">
          <div className="lg:hidden flex items-center gap-2 justify-center mb-4">
            ...
            <span className="text-xl font-light tracking-tight">StoryBook</span>
          </div>
